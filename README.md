...
<head>
    ...
    <style>
        ...
        h1 {
            margin-top: 50px;
            font-size: 40px; /* 调大标题字体大小 */
        }
        h2 {
            margin-top: 40px;
            font-size: 32px; /* 调大副标题字体大小 */
            color: #FF8A80;
        }
        h3 {
            margin-top: 30px;
            font-size: 28px; /* 调大小标题字体大小 */
            color: #FF6F61;
        }
        ul {
            list-style-type: disc;
            margin-left: 40px;
            font-size: 18px; /* 调大列表字体大小 */
        }
        ol {
            margin-left: 20px;
            font-size: 18px; /* 调大列表字体大小 */
        ...
        table {
            ...
            font-size: 18px; /* 调大表格字体大小 */
        }
        table, th, td {
            border: 1px solid #FFB6B9;
        }
        th, td {
            padding: 12px; /* 调大单元格内边距 */
            text-align: center;
        }
        th {
